...
async def main():
    async with httpx.AsyncClient() as client:
        ...
        if "queued" in states_seen and "processing" in states_seen and "completed" in states_seen:
            print("ALL PHASE C RUNTIME VERIFICATIONS PASSED!")
        else:
            print("Failed to observe all expected states (queued -> processing -> completed)!")
            exit(1)
