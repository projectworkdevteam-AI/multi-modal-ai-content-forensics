...
from sqlalchemy import String, Text, BigInteger, Integer, DateTime, Enum, ForeignKey, UniqueConstraint
...
class Report(Base):
    ...
    signed_url_expires: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
